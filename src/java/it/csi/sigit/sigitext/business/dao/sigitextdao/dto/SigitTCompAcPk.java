...
/**
 * Primary Key del DTO SigitTCompAcDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTCompAcPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTCompAcPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTCompAcPk)) {
			return false;
		}

		final SigitTCompAcPk _cast = (SigitTCompAcPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitext.business.dao.sigitextdao.dto.SigitTCompAcPk: ");
