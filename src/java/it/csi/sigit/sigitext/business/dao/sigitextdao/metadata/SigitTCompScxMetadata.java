 ...
 * @generated
 */
public class SigitTCompScxMetadata extends DAOMetadata {
	 ...
	 * DAO: [sigitTCompScx]
	 * tabella: [SIGIT_T_COMP_SCX].
	 */
	public SigitTCompScxMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [sigitTCompScx] fa riferimento
	 * (SIGIT_T_COMP_SCX).
	 * @return String
	 * @generated
	 */
