...
/**
 * Data transfer object relativo al DAO AllegatoDao.
 * @generated
 */
public class AllegatoDto extends AllegatoPk {
	...
	/**
	 * Crea una istanza di AllegatoPk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return AllegatoPk
	 * @generated
	 */
	public AllegatoPk createPk() {
		return new AllegatoPk(idAllegato);
	}
