...
/**
 * Primary Key del DTO SigitTCompRvDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTCompRvPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTCompRvPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTCompRvPk)) {
			return false;
		}

		final SigitTCompRvPk _cast = (SigitTCompRvPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitext.business.dao.sigitextdao.dto.SigitTCompRvPk: ");
