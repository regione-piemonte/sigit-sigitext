...
/**
 * Primary Key del DTO SigitTCompGfDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTCompGfPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTCompGfPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTCompGfPk)) {
			return false;
		}

		final SigitTCompGfPk _cast = (SigitTCompGfPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitext.business.dao.sigitextdao.dto.SigitTCompGfPk: ");
