...
/**
 * Data transfer object relativo al DAO SigitTCompAgDao.
 * @generated
 */
public class SigitTCompAgDto extends SigitTCompAgPk {
	...
	/**
	 * Crea una istanza di SigitTCompAgPk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return SigitTCompAgPk
	 * @generated
	 */
	public SigitTCompAgPk createPk() {
		return new SigitTCompAgPk(idTipoComponente, progressivo, dataInstall, codiceImpianto);
	}
