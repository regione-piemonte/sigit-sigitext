...
/**
 * Data transfer object relativo al DAO UnitaImmobiliareDao.
 * @generated
 */
public class UnitaImmobiliareDto extends UnitaImmobiliarePk {
	...
	/**
	 * Crea una istanza di UnitaImmobiliarePk a partire dal valore dei campi chiave del DTO
	 * 
	 * @return UnitaImmobiliarePk
	 * @generated
	 */
	public UnitaImmobiliarePk createPk() {
		return new UnitaImmobiliarePk(idUnitaImm);
	}
