...
/**
 * Primary Key del DTO AllegatoDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class AllegatoPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di AllegatoPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof AllegatoPk)) {
			return false;
		}

		final AllegatoPk _cast = (AllegatoPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitext.business.dao.sigitextdao.dto.AllegatoPk: ");
