...
/**
 * Primary Key del DTO SigitTCompCiDto.
 * E' utilizzato per tutte le operazioni di lettura dati per chiave primaria. 
 * @generated
 */
public class SigitTCompCiPk implements Serializable {
	...
	/**
	 * Method 'equals'. 
	 * Due istanze di SigitTCompCiPk sono equals se i valori di tutti i campi coincidono.
	 * 
	 * @param _other
	...
	public boolean equals(Object _other) {
		...
		if (!(_other instanceof SigitTCompCiPk)) {
			return false;
		}

		final SigitTCompCiPk _cast = (SigitTCompCiPk) _other;
	...
	public String toString() {
		...
		ret.append("it.csi.sigit.sigitext.business.dao.sigitextdao.dto.SigitTCompCiPk: ");
