 ...
 * @generated
 */
public class UnitaImmobiliareMetadata extends DAOMetadata {
	 ...
	 * DAO: [UnitaImmobiliare]
	 * tabella: [SIGIT_T_UNITA_IMMOBILIARE].
	 */
	public UnitaImmobiliareMetadata() {
	...
	/**
	 * Method 'getTableName'
	 * Restituisce il nome della tabella a cui il DAO [UnitaImmobiliare] fa riferimento
