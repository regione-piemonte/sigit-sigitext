...
/*PROTECTED REGION ID(R-1299682941) ENABLED START*/
...
public class SigitVSk4ScDaoImpl extends AbstractDAO implements SigitVSk4ScDao {
	...
	protected SigitVSk4ScDaoRowMapper attiviByCodImpiantoProgressiviRowMapper = new SigitVSk4ScDaoRowMapper(
			new String[]{"CODICE_IMPIANTO", "ID_TIPO_COMPONENTE", "PROGRESSIVO", "DATA_INSTALL", "DATA_DISMISS",
					"MATRICOLA", "MODELLO", "POTENZA_TERMICA_KW", "FK_MARCA", "DES_MARCA", "TEMPO_MANUT_ANNI"},
			SigitVSk4ScDto.class, this);
	...
	public List<SigitVSk4ScDto> findByCodImpiantoOrdered(java.lang.Integer input) throws SigitVSk4ScDaoException {
	...
	public List<SigitVSk4ScDto> findAttiviByCodImpiantoFkPg(
		...
		sql.append(
				"SELECT c.CODICE_IMPIANTO,c.ID_TIPO_COMPONENTE,c.PROGRESSIVO,DATA_INSTALL,FLG_DISMISSIONE,DATA_DISMISS,c.DATA_ULT_MOD,c.UTENTE_ULT_MOD,MATRICOLA,MODELLO,POTENZA_TERMICA_KW,FK_MARCA,DES_MARCA,DATA_CONTROLLO,TEMPO_MANUT_ANNI,ID_ALLEGATO,FK_TIPO_DOCUMENTO,DES_TIPO_DOCUMENTO ");
		/*PROTECTED REGION END*/
	...
	public List<SigitVSk4ScDto> findAttiviByCodImpiantoProgressivi(
			it.csi.sigit.sigitext.business.dao.sigitextdao.dao.filter.CompFilter input) throws SigitVSk4ScDaoException {
		LOG.debug("[SigitVSk4ScDaoImpl::findAttiviByCodImpiantoProgressivi] START");
		StringBuilder sql = new StringBuilder();
		MapSqlParameterSource paramMap = new MapSqlParameterSource();

		sql.append(
				"SELECT DISTINCT CODICE_IMPIANTO,ID_TIPO_COMPONENTE,PROGRESSIVO,DATA_INSTALL,DATA_DISMISS,MATRICOLA,MODELLO,POTENZA_TERMICA_KW,FK_MARCA,DES_MARCA,TEMPO_MANUT_ANNI ");
		sql.append(" FROM VISTA_SK4_SC");
		sql.append(" WHERE ");
